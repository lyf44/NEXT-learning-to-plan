...
def NEXT_plan(
    env, model=None, T=100, g_explore_eps=1.0, stop_when_success=False, UCB_type="kde"
):
    ...
    for i in range(T):
        ...
        # Guided selection and expansion.
            ...
            leaf_state, _, no_collision, done = expand(
                search_tree, parent_idx, model, env, extend_cnt=i
            )
            success = success or done
        ...
        if VISUALIZE:
            utils.visualize_nodes_global(
                ...
                show=False,
                save=True,
                file_name=osp.join(CUR_DIR, "../res/next_tree_{}.png".format(i)),
            )
