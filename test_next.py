...
maze_dir = osp.join(CUR_DIR, "../dataset/gibson/train/Pinesdale")
...
for epoch in range(test_num):
    ...
    if path is not None:
        ...
        utils.visualize_nodes_global(
            ...
            show=False,
            save=True,
            file_name=osp.join(CUR_DIR, "res/next_path.png"),
        )
    else:
        ...
        utils.visualize_nodes_global(
            ...
            show=False,
            save=True,
            file_name=osp.join(CUR_DIR, "res/gt.png"),
        )

        # for p in path_tmp:
        #     print(p)
        #     if not env._maze.pb_ompl_interface.is_state_valid(p):
        #         input()
